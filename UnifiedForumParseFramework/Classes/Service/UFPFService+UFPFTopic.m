...
@implementation UFPFService (UFPFTopic)
...
+ (NSArray<UFPFTopic *> *)findTopicsCreatedByUser:(UFPFUser *)fromUser orderBy:(NSString *)orderBy isOrderByAscending:(BOOL)isOrderByAscending page:(NSInteger)page pageCount:(NSInteger)pageCount error:(NSError **)error {
...
+ (NSArray<UFPFTopic *> *)findTopicsFollowedByUser:(UFPFUser *)fromUser orderBy:(NSString *)orderBy isOrderByAscending:(BOOL)isOrderByAscending page:(NSInteger)page pageCount:(NSInteger)pageCount error:(NSError **)error {
...
+ (NSArray<UFPFTopic *> *)findTopicWithCategory:(NSString * _Nullable)category
                                ...
                                fromUser:(UFPFUser * _Nullable)fromUser
...
+ (PFQuery *)buildTopicQueryWhereFromUserIsBlockedByUser:(UFPFUser *)user {
