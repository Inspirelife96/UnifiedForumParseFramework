//
//  UFPFService+UFPFReplyLike.m
//  UFPFParse
//
//  Created by XueFeng Chen on 2022/7/17.
//

#import "UFPFService+UFPFReplyLike.h"
...
@implementation UFPFService (UFPFReplyLike)
...
+ (NSArray<UFPFReplyLike *> *)_findReplyLikeFromUser:(UFPFUser *)fromUser toReply:(UFPFReply *)toReply isDeleted:(BOOL)isDeleted error:(NSError **)error {
