...
// Field keys
NSString *const PFInstalltionKeyLinkedAccount = @"linkedAccount";
...
// 自定义字段
NSString *const PFUserKeyUser = @"user"; // 用户的展示信息
NSString *const PFUserKeyBadgeCount = @"badgeCount"; // 推送统计
...
// Class key
NSString *const UFPFTopicKeyClass = @"UFPFTopic";
...
// Class key
NSString *const UFPFPostKeyClass = @"UFPFPost";
...
// Class key
NSString *const UFPFReplyKeyClass = @"UFPFReply";
...
// Class key
NSString *const UFPFCategoryKeyClass = @"UFPFCategory";
...
// Class key
NSString *const UFPFTagKeyClass = @"UFPFTag";
...
// Class key
NSString *const UFPFTopicLikeKeyClass = @"UFPFTopicLike";
...
// Class key
NSString *const UFPFPostLikeKeyClass = @"UFPFPostLike";
...
// Class key
NSString *const UFPFReplyLikeKeyClass = @"UFPFReplyLike";
...
// Class key
NSString *const UFPFTopicReportKeyClass = @"UFPFTopicReport";
...
// Class key
NSString *const UFPFPostReportKeyClass = @"UFPFPostReport";
...
// Class key
NSString *const UFPFReplyReportKeyClass = @"UFPFReplyReport";
...
// Class key
NSString *const UFPFShareKeyClass = @"UFPFShare";
...
// Class key
NSString *const UFPFFollowKeyClass = @"UFPFFollow";
...
// Class key
NSString *const UFPFTimeLineKeyClass = @"UFPFTimeLine";
...
# pragma mark - UFPFUser 表

// UFPFUser表 _User表创建user字段和其关联，真正的用户表，可读，社交属性

// Class key
NSString *const UFPFUserKeyClass = @"UFPFUser";

// Field keys
NSString *const UFPFUserKeyAccount = @"account"; // 用户
...
NSString *const UFPFUserKeyProfileviews = @"profileViews"; // 用户
NSString *const UFPFUserKeyReputation = @"reputation"; // 用户
NSString *const UFPFUserKeyTopicCount = @"topicCount"; // 用户
NSString *const UFPFUserKeyPostCount = @"postCount"; // 用户
NSString *const UFPFUserKeyFollowerCount = @"followerCount"; // 粉丝
NSString *const UFPFUserKeyFollowingCount = @"followingCount"; // 关注
NSString *const UFPFUserKeyLikedCount = @"likedCount"; // 获赞数


# pragma mark - Notification 表

// Class key
NSString *const UFPFNotificationKeyClass = @"UFPFNotification";
...
// Class key
NSString *const UFPFMessageKeyClass = @"UFPFMessage";
...
// Class key
NSString *const UFPFMessageGroupKeyClass = @"UFPFMessageGroup";
...
// Class key
NSString *const UFPFBadgeCountKeyClass = @"UFPFBadgeCount";

// Field keys
NSString *const UFPFBadgeCountKeyAccount = @"account";
NSString *const UFPFBadgeCountKeyTotalCount = @"totalCount";
NSString *const UFPFBadgeCountKeyPostCount = @"postCount";
...
// Class key
NSString *const UFPFAppInfoKeyClass = @"UFPFAppInfo";
