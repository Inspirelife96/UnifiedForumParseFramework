//
//  UFPFService+UFPFReply.m
//  UFPFParse
//
//  Created by XueFeng Chen on 2021/12/28.
//

#import "UFPFService+UFPFReply.h"
...
@implementation UFPFService (UFPFReply)
                 ...
                 error:(NSError **)error
{
    ...
    if (succeeded) {
        UFPFUser *toUser = toPost.fromUser;
...
+ (PFQuery *)buildReplyQueryWhereFromUserIsBlockedByUser:(UFPFUser *)user {
