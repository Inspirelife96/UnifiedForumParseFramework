//
//  UFPFService+UFPFPostLike.m
//  UFPFParse
//
//  Created by XueFeng Chen on 2022/7/17.
//

#import "UFPFService+UFPFPostLike.h"
...
@implementation UFPFService (UPFPPostLike)
...
+ (NSArray<UFPFPostLike *> *)_findPostLikeFromUser:(UFPFUser *)fromUser toPost:(UFPFPost *)toPost isDeleted:(BOOL)isDeleted error:(NSError **)error {
