...
@interface UFPFService (UFPFTopic)
...
+ (NSArray<UFPFTopic *> *)findTopicsCreatedByUser:(UFPFUser *)fromUser
                                          orderBy:(NSString *)orderBy
                               isOrderByAscending:(BOOL)isOrderByAscending
                                             page:(NSInteger)page
...
+ (NSArray<UFPFTopic *> *)findTopicsFollowedByUser:(UFPFUser *)fromUser
                                           orderBy:(NSString *)orderBy
                                isOrderByAscending:(BOOL)isOrderByAscending
                                              page:(NSInteger)page
                                         pageCount:(NSInteger)pageCount
